...
async function gotoArtifact(page: Page, sourceRelative: string) {
  ...
  // Wait for the Folder section to appear (descendants fetch lands
  // after the iframe mounts). Off-route tests that don't need the
  // section can skip this — only the inspector-aware cases call this
  // helper.
