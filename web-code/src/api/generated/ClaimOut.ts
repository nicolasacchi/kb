 ...
 */
confidence?: number, evidence: Array<string>, session_id?: string, model?: string, blob_sha?: string, current_blob?: string, state: string, caption: string, 
/**
 ...
 */
refs: FieldRefs, created_at: number, };
