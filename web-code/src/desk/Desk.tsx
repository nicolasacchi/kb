...
export interface DeskProps {
  ...
  /// V71-E2 — pass-through for `Drawer`'s own-body slot (the Usages dock).
  /// The Desk is shell geometry and never looks at a set's contents; it
  /// only carries the slot from the reader, which is what fetched them.
  renderDrawerBody?: (setId: string) => React.ReactNode | null;
