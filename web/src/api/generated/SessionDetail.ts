 ...
 */
memory_ids: Array<string>, id: string, kb: string, artifact_id: string, session_id: string, started_at: number, ended_at: number, duration_ms: number, message_count: number, first_user_prompt?: string, memory_count: number, source_relative: string, 
/**
